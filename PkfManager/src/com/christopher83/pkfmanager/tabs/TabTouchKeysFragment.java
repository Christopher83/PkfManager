...
/**
 * Class for the tab fragment related to the touch key presses filtering
 * @author Cristoforo Cataldo (Christopher83)
 */
public class TabTouchKeysFragment extends TabPreferenceListFragment {

	/**
	 * Class constructor
	 */
	public TabTouchKeysFragment() {
		// Invoke the base class constructor
		super();

		// Set the resource IDs for the title and the preferences showed by this tab
		_titleID = R.string.title_touchkeys;
		_preferencesID = R.xml.preferences_touchkeys;
	}
	...
	public PropertyHashTable initProperties() {
		return PkfCommon.getPkfTouchKeysProperties(this.getActivity().getApplicationContext());
	}
	...
	public void onCreate(Bundle b) {
		...
		initUpdateablePropertyPreference(R.string.id_touchkeys_ignored_kp);
	}
